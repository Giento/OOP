package hr.fer.oop.swing.ResponsiveRollingDieGUI;
...
public class RollingDieGUIResponsive extends JFrame {
    ...
    public RollingDieGUIResponsive() {
        ...
        btStart.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int noOfRolling = Integer.valueOf(lbRollings.getText());
                new Thread(() -> {
                    intensiveTask(noOfRolling);
                    SwingUtilities.invokeLater(() -> btStart.setEnabled(true));
                    SwingUtilities.invokeLater(() -> slRollings.setEnabled(true));
                }).start();
            }
        });
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                new RollingDieGUIResponsive().setVisible(true);
            }
        });
    }
}
